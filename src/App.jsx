...
const PROJECTS = [
  {
    ...
    desc: "A MERN-based expense management application that helps users track income and expenses, categorize transactions, and visualize spending through an interactive dashboard.",
    color: "#FF4D00",
  },
  {
    id: "02",
    ...
    desc: "Developed a machine learning model that recommends houses based on user preferences such as budget, location, number of bedrooms, and amenities.",
    color: "#7C3AFF",
  },
  {
    id: "03",
    ...
    desc: "An AI-powered platform that generates social media content strategies, including post ideas, hooks, captions, hashtags, and posting schedules based on a user's niche and target audience.",
    color: "#00C896",
  },
  {
    id: "04",
    ...
    desc: "A responsive personal portfolio showcasing projects, technical skills, and achievements with modern UI, smooth animations, and interactive sections.",
    color: "#F5B800",
  },
];
